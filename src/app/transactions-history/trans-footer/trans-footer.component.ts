...
@Component({
  selector: 'app-trans-footer',
  templateUrl: './trans-footer.component.html',
  styleUrls: ['./trans-footer.component.css']
})
export class TransFooterComponent implements OnInit {
  emailForm: FormGroup;
