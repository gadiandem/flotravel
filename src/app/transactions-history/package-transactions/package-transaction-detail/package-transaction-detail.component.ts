...
@Component({
  selector: 'app-package-transaction-detail',
  templateUrl: './package-transaction-detail.component.html',
  styleUrls: ['./package-transaction-detail.component.css']
})
export class PackageTransactionDetailComponent implements OnInit {
  ...
  constructor(private activeRoute: ActivatedRoute,
    ...
    private packagesService: PackagesHistoryService,
      ...
      if (userId != null) {
        ...
        this.packagesService.orderPackageDetail(this.packageOrderId).subscribe(
          (res: HistoryOrderPackageDetailRes) => {
            ...
            console.log(this.orderPackageDetail);
  ...
  cancelBooking(statement?: string) {
    ...
    this.packagesService.packagesCancelBooking(this.orderPackageDetail.id, statement).subscribe(
      (res: OrderPackageCreateRes) => {
        ...
        this.alertify.warning('booking cancellation in processing!');
  ...
  getOrderUpdate(){
    if (this.packageOrderForm.valid) {
      ...
      this.router.navigate(['/transactions/package-transactions', this.packageOrderId,'update']);
    } else {
