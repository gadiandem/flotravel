...
@Component({
  selector: 'app-flotravel-transaction',
  templateUrl: './flotravel-transaction.component.html',
  styleUrls: ['./flotravel-transaction.component.css']
})
export class FlotravelTransactionComponent implements OnInit {
