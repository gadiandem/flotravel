...
export class PakageConsumerService {
  ...
  //region
  updateRegion(regionName: string, regionId: string) {
    const region: RegionPackage = new RegionPackage();
  ...
  createRegion(data: RegionPackage) {
