...
export class PackagesHistoryService {
  ...
  private packageOrderHistoryListUrl = environment.baseUrl + 'packages/historyBooking';
  private historyPackageOrderListByDateUrl = environment.baseUrl + 'packages/historyBooking/filterByDate';
  private packageOrderHistoryDetailUrl = environment.baseUrl + 'packages/historyDetail';
  private packageOrderCancelUrl = environment.baseUrl + 'packages/cancellation';
  private packageDeleteUrl = environment.baseUrl + 'packages/delete';
