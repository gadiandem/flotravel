...
@Component({
  selector: 'app-combine-search-box',
  templateUrl: './combine-search-box.component.html',
  styleUrls: ['./combine-search-box.component.css']
})
export class CombineSearchBoxComponent implements OnInit {
  @Output() formValid = new EventEmitter<boolean>();
  @Output() searchHotelBox = new EventEmitter<HotelShoppingReq>();
  @Input() fetching: boolean;
  @Input() searchHotelListRequest: CombineShoppingReq;
  ...
  searchHotel() {
    if (this.searchForm.valid) {
      ...
      // const searchHoteListData = new CombineShoppingReq();
