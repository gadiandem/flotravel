...
@Component({
    selector: 'app-search-form-reshop',
    templateUrl: './search-form-reshop.component.html',
    styleUrls: ['./search-form-reshop.component.css']
  })
  export class SearchFormReshopComponent implements OnInit {
  ...
  searchFlight() {
    if (this.searchForm.valid) {
      ...
      if(this.orderChange){
          this.searchFlightForm.orderChange = this.orderChange;
      ...
      sessionStorage.setItem(flightConstant.CUSTOMERS_INFO,JSON.stringify(this.userInfo));
