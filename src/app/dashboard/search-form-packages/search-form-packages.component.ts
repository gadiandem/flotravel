...
@Component({
  selector: 'app-search-form-packages',
  templateUrl: './search-form-packages.component.html',
  styleUrls: ['./search-form-packages.component.css']
})
export class SearchFormPackagesComponent implements OnInit {
  ...
  constructor(protected router: Router,
    ...
    ngOnInit() {
      ...
      this.minDateEnd = this.addDays(new Date(), 1);
  ...
  initForm() {
    this.searchForm = new FormGroup({
      ...
      startDate: new FormControl(this.minDateStart, Validators.required),
      endDate: new FormControl(this.minDateEnd, Validators.required),
      rooms: new FormArray([]),
    });
