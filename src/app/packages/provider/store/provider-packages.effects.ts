...
const getPackageHotelListUrl = environment.baseUrl + "admin/packages/hotel";
const getPackageHotelRoomListUrl = environment.baseUrl + "admin/packages/hotelRoom";
const getPackageHotelListByNameUrl = environment.baseUrl + "admin/packages/hotel/search";
const getPackageInfoListUrl = environment.baseUrl + "admin/packages/packageInfo";
const getPackageRegionListUrl = environment.baseUrl + "admin/packages/region";
const getPackageSupplementListUrl = environment.baseUrl + "admin/packages/supplement";
const getPackageTourListUrl = environment.baseUrl + "admin/packages/tour";
const getPackageTransferListUrl = environment.baseUrl + "admin/packages/transfer";
const getPackageHotelFacilityListUrl = environment.baseUrl + "admin/packages/hotelFacility";

const packageHotelUrl = environment.baseUrl + "admin/packages/hotel";
const packageHotelRoomUrl = environment.baseUrl + "admin/packages/hotelRoom";
const packageInfoUrl = environment.baseUrl + "admin/packages/packageInfo";
const packageRegionUrl = environment.baseUrl + "admin/packages/region";
const packageSupplementUrl = environment.baseUrl + "admin/packages/supplement";
const packageTourUrl = environment.baseUrl + "admin/packages/tour";
const packageTransferUrl = environment.baseUrl + "admin/packages/transfer";
const packageHotelFacilityUrl = environment.baseUrl + "admin/packages/hotelFacility";

const handleGetPackageHotelListResult = (packageHotelListRes: PaginationHotelPackage) => {
...
const handleRemovePackageHotelResult = () => {
  return  new ProviderPackagesActions.GetPackageHotelListStart(null);
}
...
const handleGetPackageHotelRoomListResult = (packageHotelRoomListRes: PaginationHotelRoom) => {
...
const handleGetPackageHotelListByNameResult = (packageHotelListByNameRes: PaginationHotelPackage) => {
...
const handleRemovePackageHotelRoomResult = () => {
  ...
  return new ProviderPackagesActions.GetPackageHotelRoomListStart({packageHotelId: packageHotelId, page: null});
}
...
const handleGetPackageInfoListResult = (packageInfoListRes: PaginationPackageInfo) => {
...
const handleRemovePackageInfoResult = () => {
  return new ProviderPackagesActions.GetPackageInfoListStart(null);
}
...
const handleGetPackageSupplementListResult = (packageSupplementListRes: PaginationSupplementPackage) => {
...
const handleRemovePackageSupplementResult = () => {
  return new ProviderPackagesActions.GetPackageSupplementListStart(null);
}
...
const handleGetPackageTourListResult = (packageTourListRes: PaginationTourPackage) => {
...
const handleRemovePackageTourResult = () => {
  return new ProviderPackagesActions.GetPackageTourListStart(null);
}
...
const handleGetPackageTransferListResult = (packageTransferListRes: PaginationTransferPackage) => {
...
const handleRemovePackageTransferResult = () => {
  return new ProviderPackagesActions.GetPackageTransferListStart(null);
}
...
const handleGetPackageHotelFacilityListResult = (packageHotelFacilityListRes: PaginationHotelFacility) => {
...
const handleRemovePackageHotelFacilityResult = () => {
  return new ProviderPackagesActions.GetPackageHotelFacilityListStart(null);
}
...
@Injectable()
export class ProviderPackagesEffects {
  @Effect()
  getPackageHotelList = this.actions$.pipe(
    ...
    switchMap((actionData: ProviderPackagesActions.GetPackageHotelListStart) => {
      ...
      if(actionData && actionData.payload){
         pageable = actionData.payload.data;
      } else {
        pageable.page = 0;
      ...
      return this.http
        .get<PaginationHotelPackage>(getPackageHotelListUrl, {params})
        .pipe(
          map((res: PaginationHotelPackage) => {
  ...
  getPackageHotelRoomList = this.actions$.pipe(
    ...
    switchMap((actionData: ProviderPackagesActions.GetPackageHotelRoomListStart) => {
      ...
      let pageable: Pageable = new Pageable();
      if(actionData && actionData.payload){
         pageable = actionData.payload.page;
      } else {
        pageable.page = 0;
        pageable.pageSize = 10;
      }
      ...
      return this.http.get<PaginationHotelRoom>(getPackageHotelRoomListUrl, {headers, params}).pipe(
        map((res : PaginationHotelRoom) => {
  ...
  getPackageHotelListByName = this.actions$.pipe(
    ...
    switchMap((dataAction : ProviderPackagesActions.GetPackageHotelListByNameStart) => {
      ...
      return this.http.get<PaginationHotelPackage>(getPackageHotelListByNameUrl, {params}).pipe(
        map((res: PaginationHotelPackage) => {
  ...
  getPackageInfoList = this.actions$.pipe(
    ...
    switchMap((actionData: ProviderPackagesActions.GetPackageInfoListStart) => {
      ...
      .set("page", (pageable.page.toString()))
      .set("pageSize", (pageable.pageSize.toString()));
      return this.http.get<PaginationPackageInfo>(getPackageInfoListUrl, {params}).pipe(
        map((res: PaginationPackageInfo) => {
  ...
  getPackageSupplementList = this.actions$.pipe(
    ...
    switchMap((actionData : ProviderPackagesActions.GetPackageSupplementListStart) => {
      ...
      .set("page", (pageable.page.toString()))
      .set("pageSize", (pageable.pageSize.toString()));
      return this.http.get<PaginationSupplementPackage>(getPackageSupplementListUrl, {params}).pipe(
        map((res: PaginationSupplementPackage) => {
  ...
  getPackageTourList = this.actions$.pipe(
    ...
    switchMap((actionData : ProviderPackagesActions.GetPackageTourListStart) => {
      ...
      .set("page", (pageable.page.toString()))
      .set("pageSize", (pageable.pageSize.toString()));
      return this.http.get<PaginationTourPackage>(getPackageTourListUrl, {params}).pipe(
        map((res: PaginationTourPackage) => {
  ...
  getPackageTransferList = this.actions$.pipe(
    ...
    switchMap((actionData : ProviderPackagesActions.GetPackageTransferListStart) => {
      ...
      .set("page", (pageable.page.toString()))
      .set("pageSize", (pageable.pageSize.toString()));
      return this.http.get<PaginationTransferPackage>(getPackageTransferListUrl, {params}).pipe(
        map((res: PaginationTransferPackage) => {
  ...
  getPackageHotelFacilityList = this.actions$.pipe(
    ...
    switchMap((actionData : ProviderPackagesActions.GetPackageHotelFacilityListStart) => {
      ...
      .set("page", (pageable.page.toString()))
      .set("pageSize", (pageable.pageSize.toString()));
      return this.http.get<PaginationHotelFacility>(getPackageHotelFacilityListUrl, {params}).pipe(
        map((res: PaginationHotelFacility) => {
