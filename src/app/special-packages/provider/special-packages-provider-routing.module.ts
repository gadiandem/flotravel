...
import { SpecialProviderLayoutComponent } from 'src/app/shared/layouts';
...
const routes: Routes = [
  {
    path: '', component: SpecialProviderLayoutComponent,
    children: [
...
export class SpecialPackagesProviderRoutingModule { }
