...
export class PackageInfoEditComponent implements OnInit {
  ...
  getSupplementList() {
    this.providerService.getPackageSupplementList().subscribe((res: SupplementPackage[]) => {
  ...
  getTourList() {
    this.providerService.getPackageTourList().subscribe((res: TourPackage[]) => {
      this.tours = res;
      this.updateTours();
    }, e => {
      console.log(e);
  ...
  getTransferList() {
    this.providerService.getPackageTransferList().subscribe((res: TransferInPackage[]) => {
      // this.supplements = res;
      res.forEach(t => {
  ...
  getPackageHotelList() {
    this.providerService.getPackageHotelList().subscribe((res: any) => {
      this.hotelList = res;
