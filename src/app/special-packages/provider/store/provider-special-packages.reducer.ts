...
export interface State {
  packageHotelListRes: HotelPackage[];
  ...
  packageHotelListByNameRes: HotelPackage[];
  packageHotelRoomListRes:  HotelRoomPackage[];
  ...
  packageInfoListRes: PackageInfo[];
  ...
  packageSupplementListRes: SupplementPackage[];
  ...
  packageTourListRes: TourPackage[];
  ...
  packageTransferListRes: TransferInPackage[];
  ...
  packageHotelFacilityListRes: HotelFacility[];
...
export function providerSpecialPackagesReducer(
  state: State = initialState,
  action: ProviderPackagesActions.ProviderSpecialPackagesActions
) {
  switch (action.type) {
    case ProviderPackagesActions.HANDLE_FAIL:
      return {
        ...state,
        packageHotelRoomListRes: [],
    ...
    case ProviderPackagesActions.GET_PACKAGE_HOTEL_LIST_SUCCESS:
      return {
        ...state,
        packageHotelListRes: [...action.payload],
        errorMessage: null,
        loading: false,
        failure: false
      };
    ...
    case ProviderPackagesActions.GET_PACKAGE_HOTEL_LIST_BY_NAME_SUCCESS:
      return {
        ...state,
        packageHotelListByNameRes: [...action.payload],
        loading: false,
        errorMessage: null,
        failure: false
      };
    ...
    case ProviderPackagesActions.GET_PACKAGE_HOTEL_ROOM_LIST_SUCCESS:
      return {
        ...state,
        packageHotelRoomListRes: [...action.payload],
        loading: false,
        errorMessage: null,
        failure: false
      };
    ...
    case ProviderPackagesActions.GET_PACKAGE_INFO_LIST_SUCCESS:
      return {
        ...state,
        packageInfoListRes: [...action.payload],
        loading: false,
        errorMessage: null,
        failure: false
      };
    ...
    case ProviderPackagesActions.GET_PACKAGE_SUPPLEMENT_LIST_SUCCESS:
      return {
        ...state,
        packageSupplementListRes: [...action.payload],
        loading: false,
        errorMessage: null,
        failure: false
      };
    ...
    case ProviderPackagesActions.GET_PACKAGE_TOUR_LIST_SUCCESS:
      return {
        ...state,
        packageTourListRes: [...action.payload],
        loading: false,
        errorMessage: null,
        failure: false
      };
    ...
    case ProviderPackagesActions.GET_PACKAGE_TRANSFER_LIST_SUCCESS:
      return {
        ...state,
        packageTransferListRes: [...action.payload],
        loading: false,
        errorMessage: null,
        failure: false
      };
    ...
    case ProviderPackagesActions.GET_PACKAGE_HOTEL_FACILITY_LIST_SUCCESS:
      return {
        ...state,
        packageHotelFacilityListRes: [...action.payload],
        loading: false,
        errorMessage: null,
        failure: false
      };
