...
export const HANDLE_FAIL = '[Special_Package_Provider] HANDLE_FAIL';
export const GET_PACKAGE_HOTEL_LIST_START = '[Special_Package_Provider] GET_PACKAGE_HOTEL_LIST_START';
export const GET_PACKAGE_HOTEL_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_HOTEL_LIST_SUCCESS';
export const GET_PACKAGE_HOTEL_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_HOTEL_LIST_FAIL';
export const REMOVE_PACKAGE_HOTEL_START = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_START';
export const REMOVE_PACKAGE_HOTEL_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_SUCCESS';
export const REMOVE_PACKAGE_HOTEL_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_FAIL';
export const CREATE_PACKAGE_HOTEL_START = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_START';
export const CREATE_PACKAGE_HOTEL_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_SUCCESS';
export const CREATE_PACKAGE_HOTEL_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_FAIL';
export const GET_PACKAGE_HOTEL_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_HOTEL_DETAIL_START';
export const GET_PACKAGE_HOTEL_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_HOTEL_DETAIL_SUCCESS';
export const GET_PACKAGE_HOTEL_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_HOTEL_DETAIL_FAIL';
export const UPDATE_PACKAGE_HOTEL_START = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_START';
export const UPDATE_PACKAGE_HOTEL_SUCCESS = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_SUCCESS';
export const UPDATE_PACKAGE_HOTEL_FAIL = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_FAIL';
export const GET_PACKAGE_HOTEL_LIST_BY_NAME_START = '[Special_Package_Provider] GET_PACKAGE_HOTEL_LIST_BY_NAME_START';
export const GET_PACKAGE_HOTEL_LIST_BY_NAME_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_HOTEL_LIST_BY_NAME_SUCCESS';
export const GET_PACKAGE_HOTEL_LIST_BY_NAME_FAIL = '[Special_Package_Provider] GET_PACKAGE_HOTEL_LIST_BY_NAME_FAIL';
export const GET_PACKAGE_HOTEL_ROOM_LIST_START = '[Special_Package_Provider] GET_PACKAGE_HOTEL_ROOM_LIST_START';
export const GET_PACKAGE_HOTEL_ROOM_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_HOTEL_ROOM_LIST_SUCCESS';
export const GET_PACKAGE_HOTEL_ROOM_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_HOTEL_ROOM_LIST_FAIL';
export const REMOVE_PACKAGE_HOTEL_ROOM_START = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_ROOM_START';
export const REMOVE_PACKAGE_HOTEL_ROOM_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_ROOM_SUCCESS';
export const REMOVE_PACKAGE_HOTEL_ROOM_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_ROOM_FAIL';
export const CREATE_PACKAGE_HOTEL_ROOM_START = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_ROOM_START';
export const CREATE_PACKAGE_HOTEL_ROOM_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_ROOM_SUCCESS';
export const CREATE_PACKAGE_HOTEL_ROOM_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_ROOM_FAIL';
export const GET_PACKAGE_HOTEL_ROOM_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_HOTEL_ROOM_DETAIL_START';
export const GET_PACKAGE_HOTEL_ROOM_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_HOTEL_ROOM_DETAIL_SUCCESS';
export const GET_PACKAGE_HOTEL_ROOM_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_HOTEL_ROOM_DETAIL_FAIL';
export const UPDATE_PACKAGE_HOTEL_ROOM_START = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_ROOM_START';
export const UPDATE_PACKAGE_HOTEL_ROOM_SUCCESS = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_ROOM_SUCCESS';
export const UPDATE_PACKAGE_HOTEL_ROOM_FAIL = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_ROOM_FAIL';
export const GET_PACKAGE_INFO_LIST_START = '[Special_Package_Provider] GET_PACKAGE_INFO_LIST_START';
export const GET_PACKAGE_INFO_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_INFO_LIST_SUCCESS';
export const GET_PACKAGE_INFO_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_INFO_LIST_FAIL';
export const GET_PACKAGE_INFO_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_INFO_DETAIL_START';
export const GET_PACKAGE_INFO_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_INFO_DETAIL_SUCCESS';
export const GET_PACKAGE_INFO_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_INFO_DETAIL_FAIL';
export const CREATE_PACKAGE_INFO_START = '[Special_Package_Provider] CREATE_PACKAGE_INFO_START';
export const CREATE_PACKAGE_INFO_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_INFO_SUCCESS';
export const CREATE_PACKAGE_INFO_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_INFO_FAIL';
export const REMOVE_PACKAGE_INFO_START = '[Special_Package_Provider] REMOVE_PACKAGE_INFO_START';
export const REMOVE_PACKAGE_INFO_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_INFO_SUCCESS';
export const REMOVE_PACKAGE_INFO_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_INFO_FAIL';
export const GET_PACKAGE_REGION_LIST_START = '[Special_Package_Provider] GET_PACKAGE_REGION_LIST_START';
export const GET_PACKAGE_REGION_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_REGION_LIST_SUCCESS';
export const GET_PACKAGE_REGION_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_REGION_LIST_FAIL';
export const GET_PACKAGE_REGION_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_REGION_DETAIL_START';
export const GET_PACKAGE_REGION_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_REGION_DETAIL_SUCCESS';
export const GET_PACKAGE_REGION_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_REGION_DETAIL_FAIL';
export const REMOVE_PACKAGE_REGION_START = '[Special_Package_Provider] REMOVE_PACKAGE_REGION_START';
export const REMOVE_PACKAGE_REGION_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_REGION_SUCCESS';
export const REMOVE_PACKAGE_REGION_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_REGION_FAIL';
export const CREATE_PACKAGE_REGION_START = '[Special_Package_Provider] CREATE_PACKAGE_REGION_START';
export const CREATE_PACKAGE_REGION_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_REGION_SUCCESS';
export const CREATE_PACKAGE_REGION_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_REGION_FAIL';
export const UPDATE_PACKAGE_REGION_START = '[Special_Package_Provider] UPDATE_PACKAGE_REGION_START';
export const UPDATE_PACKAGE_REGION_SUCCESS = '[Special_Package_Provider] UPDATE_PACKAGE_REGION_SUCCESS';
export const UPDATE_PACKAGE_REGION_FAIL = '[Special_Package_Provider] UPDATE_PACKAGE_REGION_FAIL';
export const GET_PACKAGE_SUPPLEMENT_LIST_START = '[Special_Package_Provider] GET_PACKAGE_SUPPLEMENT_LIST_START';
export const GET_PACKAGE_SUPPLEMENT_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_SUPPLEMENT_LIST_SUCCESS';
export const GET_PACKAGE_SUPPLEMENT_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_SUPPLEMENT_LIST_FAIL';
export const GET_PACKAGE_SUPPLEMENT_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_SUPPLEMENT_DETAIL_START';
export const GET_PACKAGE_SUPPLEMENT_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_SUPPLEMENT_DETAIL_SUCCESS';
export const GET_PACKAGE_SUPPLEMENT_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_SUPPLEMENT_DETAIL_FAIL';
export const CREATE_PACKAGE_SUPPLEMENT_START = '[Special_Package_Provider] CREATE_PACKAGE_SUPPLEMENT_START';
export const CREATE_PACKAGE_SUPPLEMENT_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_SUPPLEMENT_SUCCESS';
export const CREATE_PACKAGE_SUPPLEMENT_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_SUPPLEMENT_FAIL';
export const REMOVE_PACKAGE_SUPPLEMENT_START = '[Special_Package_Provider] REMOVE_PACKAGE_SUPPLEMENT_START';
export const REMOVE_PACKAGE_SUPPLEMENT_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_SUPPLEMENT_SUCCESS';
export const REMOVE_PACKAGE_SUPPLEMENT_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_SUPPLEMENT_FAIL';
export const UPDATE_PACKAGE_SUPPLEMENT_START = '[Special_Package_Provider] UPDATE_PACKAGE_SUPPLEMENT_START';
export const UPDATE_PACKAGE_SUPPLEMENT_SUCCESS = '[Special_Package_Provider] UPDATE_PACKAGE_SUPPLEMENT_SUCCESS';
export const UPDATE_PACKAGE_SUPPLEMENT_FAIL = '[Special_Package_Provider] UPDATE_PACKAGE_SUPPLEMENT_FAIL';
export const GET_PACKAGE_TOUR_LIST_START = '[Special_Package_Provider] GET_PACKAGE_TOUR_LIST_START';
export const GET_PACKAGE_TOUR_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_TOUR_LIST_SUCCESS';
export const GET_PACKAGE_TOUR_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_TOUR_LIST_FAIL';
export const GET_PACKAGE_TOUR_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_TOUR_DETAIL_START';
export const GET_PACKAGE_TOUR_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_TOUR_DETAIL_SUCCESS';
export const GET_PACKAGE_TOUR_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_TOUR_DETAIL_FAIL';
export const CREATE_PACKAGE_TOUR_START = '[Special_Package_Provider] CREATE_PACKAGE_TOUR_START';
export const CREATE_PACKAGE_TOUR_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_TOUR_SUCCESS';
export const CREATE_PACKAGE_TOUR_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_TOUR_FAIL';
export const REMOVE_PACKAGE_TOUR_START = '[Special_Package_Provider] REMOVE_PACKAGE_TOUR_START';
export const REMOVE_PACKAGE_TOUR_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_TOUR_SUCCESS';
export const REMOVE_PACKAGE_TOUR_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_TOUR_FAIL';
export const UPDATE_PACKAGE_TOUR_START = '[Special_Package_Provider] UPDATE_PACKAGE_TOUR_START';
export const UPDATE_PACKAGE_TOUR_SUCCESS = '[Special_Package_Provider] UPDATE_PACKAGE_TOUR_SUCCESS';
export const UPDATE_PACKAGE_TOUR_FAIL = '[Special_Package_Provider] UPDATE_PACKAGE_TOUR_FAIL';
export const GET_PACKAGE_TRANSFER_LIST_START = '[Special_Package_Provider] GET_PACKAGE_TRANSFER_LIST_START';
export const GET_PACKAGE_TRANSFER_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_TRANSFER_LIST_SUCCESS';
export const GET_PACKAGE_TRANSFER_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_TRANSFER_LIST_FAIL';
export const GET_PACKAGE_TRANSFER_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_TRANSFER_DETAIL_START';
export const GET_PACKAGE_TRANSFER_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_TRANSFER_DETAIL_SUCCESS';
export const GET_PACKAGE_TRANSFER_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_TRANSFER_DETAIL_FAIL';
export const CREATE_PACKAGE_TRANSFER_START = '[Special_Package_Provider] CREATE_PACKAGE_TRANSFER_START';
export const CREATE_PACKAGE_TRANSFER_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_TRANSFER_SUCCESS';
export const CREATE_PACKAGE_TRANSFER_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_TRANSFER_FAIL';
export const REMOVE_PACKAGE_TRANSFER_START = '[Special_Package_Provider] REMOVE_PACKAGE_TRANSFER_START';
export const REMOVE_PACKAGE_TRANSFER_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_TRANSFER_SUCCESS';
export const REMOVE_PACKAGE_TRANSFER_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_TRANSFER_FAIL';
export const UPDATE_PACKAGE_TRANSFER_START = '[Special_Package_Provider] UPDATE_PACKAGE_TRANSFER_START';
export const UPDATE_PACKAGE_TRANSFER_SUCCESS = '[Special_Package_Provider] UPDATE_PACKAGE_TRANSFER_SUCCESS';
export const UPDATE_PACKAGE_TRANSFER_FAIL = '[Special_Package_Provider] UPDATE_PACKAGE_TRANSFER_FAIL';
export const GET_PACKAGE_HOTEL_FACILITY_LIST_START = '[Special_Package_Provider] GET_PACKAGE_HOTEL_FACILITY_LIST_START';
export const GET_PACKAGE_HOTEL_FACILITY_LIST_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_HOTEL_FACILITY_LIST_SUCCESS';
export const GET_PACKAGE_HOTEL_FACILITY_LIST_FAIL = '[Special_Package_Provider] GET_PACKAGE_HOTEL_FACILITY_LIST_FAIL';
export const GET_PACKAGE_HOTEL_FACILITY_DETAIL_START = '[Special_Package_Provider] GET_PACKAGE_HOTEL_FACILITY_DETAIL_START';
export const GET_PACKAGE_HOTEL_FACILITY_DETAIL_SUCCESS = '[Special_Package_Provider] GET_PACKAGE_HOTEL_FACILITY_DETAIL_SUCCESS';
export const GET_PACKAGE_HOTEL_FACILITY_DETAIL_FAIL = '[Special_Package_Provider] GET_PACKAGE_HOTEL_FACILITY_DETAIL_FAIL';
export const CREATE_PACKAGE_HOTEL_FACILITY_START = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_FACILITY_START';
export const CREATE_PACKAGE_HOTEL_FACILITY_SUCCESS = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_FACILITY_SUCCESS';
export const CREATE_PACKAGE_HOTEL_FACILITY_FAIL = '[Special_Package_Provider] CREATE_PACKAGE_HOTEL_FACILITY_FAIL';
export const REMOVE_PACKAGE_HOTEL_FACILITY_START = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_FACILITY_START';
export const REMOVE_PACKAGE_HOTEL_FACILITY_SUCCESS = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_FACILITY_SUCCESS';
export const REMOVE_PACKAGE_HOTEL_FACILITY_FAIL = '[Special_Package_Provider] REMOVE_PACKAGE_HOTEL_FACILITY_FAIL';
export const UPDATE_PACKAGE_HOTEL_FACILITY_START = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_FACILITY_START';
export const UPDATE_PACKAGE_HOTEL_FACILITY_SUCCESS = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_FACILITY_SUCCESS';
export const UPDATE_PACKAGE_HOTEL_FACILITY_FAIL = '[Special_Package_Provider] UPDATE_PACKAGE_HOTEL_FACILITY_FAIL';
...
export type ProviderSpecialPackagesActions =
  | HandleFail
