...
export const SEARCH_PACKAGESLIST_START = '[Special_Pakcages] SEARCH_PACKAGESLIST_START';
export const SEARCH_PACKAGESLIST_SUCCESS = '[Special_Pakcages] SEARCH_PACKAGESLIST_SUCCESS';
export const SEARCH_PACKAGESLIST_FAIL = '[Special_Pakcages] SEARCH_PACKAGESLIST_FAIL';

export const PACKAGES_HOTEL_DETAIL_START = '[Special_Pakcages] PACKAGES_HOTEL_DETAIL_START';
export const PACKAGES_HOTEL_DETAIL_SUCCESS = '[Special_Pakcages] PACKAGES_HOTEL_DETAIL_SUCCESS';
export const PACKAGES_HOTEL_DETAIL_FAIL = '[Special_Pakcages] PACKAGES_HOTEL_DETAIL_FAIL';

export const SELECTED_ROOM = '[Special_Pakcages] SELECTED_ROOM';

export const PACKAGES_SUPPLEMENT_START = '[Special_Pakcages] PACKAGES_SUPPLEMENT_START';
export const PACKAGES_SUPPLEMENT_SUCCESS = '[Special_Pakcages] PACKAGES_SUPPLEMENT_SUCCESS';
export const PACKAGES_SUPPLEMENT_FAIL = '[Special_Pakcages] PACKAGES_SUPPLEMENT_FAIL';

export const PACKAGES_TOUR_START = '[Special_Pakcages] PACKAGES_TOUR_START';
export const PACKAGES_TOUR_SUCCESS = '[Special_Pakcages] PACKAGES_TOUR_SUCCESS';
export const PACKAGES_TOUR_FAIL = '[Special_Pakcages] PACKAGES_TOUR_FAIL';

export const PACKAGES_TRANSFER_START = '[Special_Pakcages] PACKAGES_TRANSFER_START';
export const PACKAGES_TRANSFER_SUCCESS = '[Special_Pakcages] PACKAGES_TRANSFER_SUCCESS';
export const PACKAGES_TRANSFER_FAIL = '[Special_Pakcages] PACKAGES_TRANSFER_FAIL';

export const PACKAGES_OPTIONAL_START = '[Special_Pakcages] PACKAGES_OPTIONAL_START';
export const PACKAGES_OPTIONAL_SUCCESS = '[Special_Pakcages] PACKAGES_OPTIONAL_SUCCESS';
export const PACKAGES_OPTIONAL_FAIL = '[Special_Pakcages] PACKAGES_OPTIONAL_FAIL';

export const PACKAGES_SUMMARY_START = '[Special_Pakcages] PACKAGES_SUMMARY_START';
export const PACKAGES_SUMMARY_SUCCESS = '[Special_Pakcages] PACKAGES_SUMMARY_SUCCESS';
export const PACKAGES_SUMMARY_FAIL = '[Special_Pakcages] PACKAGES_SUMMARY_FAIL';

export const GET_VCN_START = '[Special_Pakcages] GET_VCN_START';
export const GET_VCN_SUCCESS = '[Special_Pakcages] GET_VCN_SUCCESS';
export const GET_VCN_FAIL = '[Special_Pakcages] GET_VCN_FAIL';

export const PAYMENT_PACKAGES_START = '[Special_Pakcages] PAYMENT_PACKAGES_START';
export const PAYMENT_PACKAGES_SUCCESS = '[Special_Pakcages] PAYMENT_PACKAGES_SUCCESS';
export const PAYMENT_PACKAGES_FAIL = '[Special_Pakcages] PAYMENT_PACKAGES_FAIL';
...
export class SearchPackagesListSuccess implements Action {
...
export type SpecialPackagesActions =
  | SearchPackagesListStart
  | SearchPackagesListSuccess
