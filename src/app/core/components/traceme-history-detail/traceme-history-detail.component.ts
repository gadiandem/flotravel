...
@Component({
  selector: 'app-traceme-history-detail',
  templateUrl: './traceme-history-detail.component.html',
  styleUrls: ['./traceme-history-detail.component.css']
})
export class TracemeHistoryDetailComponent implements OnInit {
  tracemeId: string;
  ...
  ngOnInit() {
    ...
    this.activeRoute.params.subscribe((params: Params) => {
      this.tracemeId = params["tracemeId"];
