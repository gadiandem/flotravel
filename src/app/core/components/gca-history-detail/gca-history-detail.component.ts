...
@Component({
  selector: 'app-gca-history-detail',
  templateUrl: './gca-history-detail.component.html',
  styleUrls: ['./gca-history-detail.component.css']
})
export class GcaHistoryDetailComponent implements OnInit {
