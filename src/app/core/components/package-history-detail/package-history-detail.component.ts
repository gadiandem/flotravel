...
@Component({
  selector: 'app-package-history-detail',
  templateUrl: './package-history-detail.component.html',
  styleUrls: ['./package-history-detail.component.css']
})
export class PackageHistoryDetailComponent implements OnInit {
  ...
  getOrderUpdate(){
    if (this.packageOrderForm.valid) {
      ...
      this.router.navigate(['/packages/history', this.packageOrderId,'update']);
    } else {
