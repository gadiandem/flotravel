...
@Component({
  templateUrl: './commission-agent-detail.component.html',
  styleUrls: ['./commission-agent-detail.component.css']
})
export class CommissionAgentDetailComponent implements OnInit, OnDestroy {
  ...
  fetRuleDetail() {
    this.commissionAgentService.getCommissionDetail(this.user.id, this.commissionId).subscribe(
      res => {
